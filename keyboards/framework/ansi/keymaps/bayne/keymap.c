...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     *         ├─────┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴────┤
     * 13 keys │ Esc  │ A │ S │ D │ F │ G │ H │ J │ K │ L │ ; │ ' │ Enter │
     *         ├──────┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴───────┤
    ...
    [_FN] = LAYOUT(
        ...
        _______, _______, KC_SYRQ, RGB_RMOD,RGB_HUD, RGB_SAD, KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, _______, _______,          _______,
